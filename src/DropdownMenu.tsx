...
export default function DropdownMenu({
  ...
  const contentClasses = `ui-menu rounded-lg shadow-xl z-[200] px-1 pt-0.5 pb-0.5 flex flex-col select-none max-h-[min(60vh,24rem)] min-w-0 ${internalSearch ? 'overflow-hidden' : 'overflow-y-auto scrollbar-custom'}`;
