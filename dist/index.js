"use client";
import { jsxs as $, jsx as o, Fragment as Ne } from "react/jsx-runtime";
...
if (Fe) {
  ...
  let n = null, r = null;
  const a = "__penClick", i = /* @__PURE__ */ new Set(["color", "file", "date", "datetime-local", "month", "time", "week"]);
  window.addEventListener("pointerdown", (l) => {
    ...
    if (c instanceof HTMLInputElement && i.has(c.type)) {
      try {
        c.showPicker();
      } catch {
      }
...
function Wn(e, t, n, r) {
  const a = ++e.current, i = { transition: t.style.transition, transform: t.style.transform, transformOrigin: t.style.transformOrigin, opacity: t.style.opacity };
  t.style.transition = "none", t.style.transformOrigin = "50% 50%", t.style.transform = `scale(${kt})`, t.style.opacity = "0", t.getBoundingClientRect(), requestAnimationFrame(() => {
    e.current === a && requestAnimationFrame(() => {
      ...
      t.style.transformOrigin = `${l.x * 100}% ${l.y * 100}%`, t.style.transition = `transform ${Se}ms ${vt}, opacity ${wt}ms ease`, t.style.transform = "none", t.style.opacity = "", window.setTimeout(() => {
        e.current === a && (t.style.transition = i.transition, t.style.transform = i.transform, t.style.transformOrigin = i.transformOrigin, t.style.opacity = i.opacity, r == null || r());
      }, Se + 60);
    });
  });
}
function Yn(e, t, n, r) {
  const a = ++e.current, i = { transition: t.style.transition, transform: t.style.transform, transformOrigin: t.style.transformOrigin, opacity: t.style.opacity, pointerEvents: t.style.pointerEvents, visibility: t.style.visibility }, l = Zt(t, n);
  t.style.transition = `transform ${Se}ms ${vt}, opacity ${wt}ms ease`, t.style.transformOrigin = `${l.x * 100}% ${l.y * 100}%`, t.style.transform = `scale(${kt})`, t.style.opacity = "0", t.style.pointerEvents = "none", window.setTimeout(() => {
    e.current === a && (t.style.visibility = "hidden", r == null || r(), requestAnimationFrame(() => {
      e.current !== a || t.isConnected || (t.style.transition = i.transition, t.style.transform = i.transform, t.style.transformOrigin = i.transformOrigin, t.style.opacity = i.opacity, t.style.pointerEvents = i.pointerEvents, t.style.visibility = i.visibility);
    }));
  }, Se + 60);
}
function qn(e, t, n) {
  const r = e.cloneNode(!0), a = e.getBoundingClientRect(), i = a.width > 0 || a.height > 0 ? a : n ?? a;
  ...
  const l = (t == null ? void 0 : t()) ?? null, u = l ? Gt({ left: i.left, top: i.top, width: i.width, height: i.height }, l) : { x: 0.5, y: 0.5 };
...
function Nt(e) {
  const t = x(null), [n, r] = B(!1), a = x(null), i = x(0), l = V((p) => {
    ...
    const g = t.current, w = ++i.current;
    queueMicrotask(() => {
      w === i.current && t.current === g && (t.current = null, r(!1), !(!g || !e.cloneOnUnmount || !c.current) && g.style.visibility !== "hidden" && rt(d.current) && qn(g, s.current, a.current));
    });
  }, []), u = V(() => {
    const p = t.current;
...
function No(e, t) {
  ...
  const a = () => {
    ...
    const l = r.current;
    if (!l) return;
    const u = e.current.getBoundingClientRect(), c = i.getBoundingClientRect(), f = l.innerWidth, s = Jt(l), h = c.right - f;
    if (h > 0) {
      const d = Math.min(h + 8, c.left);
      i.style.left = `${c.left - u.left - d}px`;
    }
    c.left < 0 && (i.style.left = `${-u.left + 4}px`), c.bottom > s.bottom + 4 && (i.style.top = "auto", i.style.bottom = "100%", i.getBoundingClientRect().top < s.top && (i.style.bottom = "auto", i.style.top = `${-u.top + s.top + 4}px`, i.style.maxHeight = `${s.height - 8}px`));
  };
  pe(() => {
    if (a(), !t) return;
    const i = r.current, l = (i == null ? void 0 : i.visualViewport) ?? null;
    return l == null || l.addEventListener("resize", a), l == null || l.addEventListener("scroll", a), i == null || i.addEventListener("resize", a), () => {
      l == null || l.removeEventListener("resize", a), l == null || l.removeEventListener("scroll", a), i == null || i.removeEventListener("resize", a);
    };
  }, [t, e]);
}
function Un(e, t, n, r) {
  ...
  i.current = a, pe(() => {
    ...
    const c = () => {
      u = 0;
      const v = l.getBoundingClientRect(), p = i.current;
      if (!p) return;
    ...
    }, s = i.current ?? null, h = (s == null ? void 0 : s.document) ?? null;
...
function Qe() {
  const e = x([]), [t, n] = B(-1), [r, a] = B(!1), [i, l] = B(0), u = V((h) => (e.current = [...e.current, h], l((d) => d + 1), () => {
...
function nn(e) {
  ...
  const a = t && r.current ? t.items.indexOf(r.current) : -1, i = !!t && !e.disabled && a >= 0 && a === t.highlightedIndex;
  return { api: t, myIndex: a, highlighted: i, setPointer: (u) => {
      ...
      if (s.key === "ArrowDown" || s.key === "ArrowUp") {
        ...
        for (let z = 0; z < h.length; z++) {
          ...
          if (h[H].label.toLowerCase().startsWith(g)) {
            i.current.setHighlighted(H, "keyboard");
            return;
          }
        }
      }
...
function Rt(e, t, n, r, a, i) {
  ...
  c.current = a;
  const f = x(!1);
  f.current || (f.current = !0, i.current = (s) => {
...
function St(e, t) {
  ...
  r.current || (r.current = !0, t.current = (a) => {
    ...
    i.scrollHeight > i.clientHeight && (a.preventDefault(), i.scrollTop += a.deltaY);
  });
}
function et({
  open: e,
  ...
  return /* @__PURE__ */ $(j.Root, { open: e || A, onOpenChange: k, modal: !1, children: [
    /* @__PURE__ */ o(j.Trigger, { asChild: !0, children: de }),
    /* @__PURE__ */ o(j.Portal, { container: g ?? void 0, children: /* @__PURE__ */ o($t.Provider, { value: l, children: /* @__PURE__ */ o(zt.Provider, { value: { chain: h, setChain: d, morph: c, keyboardOpened: v, setKeyboardOpened: p }, children: /* @__PURE__ */ o(Ke.Provider, { value: L, children: /* @__PURE__ */ o(
      j.Content,
      {
        ref: O,
        "data-theme": l,
        "data-ui-fixed": !0,
        className: `ui-menu rounded-lg shadow-xl z-[200] p-1 flex flex-col select-none max-h-[min(60vh,24rem)] overflow-y-auto min-w-0 scrollbar-custom ${i || ""} ${f || ""}`,
        style: {
...
function $o({
  ...
  const b = Et(), [y, C] = B(null), [S, O] = B(""), Y = x(null), Q = x(null);
  K(() => {
    ...
    const T = (k) => {
      ...
      if (k.key === "ArrowDown" || k.key === "ArrowUp") {
        ...
        const ie = ce.activeElement;
        let he = ie ? le.indexOf(ie) : -1;
        if (he < 0 && ie) {
          const we = ie.closest("[data-active]"), Ce = we == null ? void 0 : we.querySelector('[role="menuitem"]:first-child');
          Ce && (he = ge.indexOf(Ce));
        }
      ...
      if (k.key === "ArrowLeft" || k.key === "ArrowRight") {
        const ie = ce.activeElement, he = ie == null ? void 0 : ie.closest("[data-active]");
        if (!he) return;
        k.preventDefault(), k.stopImmediatePropagation();
        const be = [...he.querySelectorAll('[role="menuitem"]')].slice(1);
        if (be.length === 0) return;
        const ze = ie && he.contains(ie) ? be.indexOf(ie) : -1, we = k.key === "ArrowRight" ? 1 : -1, Ce = ze < 0 ? 0 : (ze + we + be.length) % be.length;
  ...
  const ee = (T, F) => {
    ...
    y && S.trim() && i(y, S.trim()), C(null);
  }, _ = () => {
    C(null);
  }, te = U || H.replace(/S$/, "").replace(/s$/, "");
  return /* @__PURE__ */ $(et, { open: e, onOpenChange: (T) => {
    T ? (C(null), O("")) : (y && S.trim() && i(y, S.trim()), C(null), O("")), (!T || !p) && t(T);
  }, width: "w-80", theme: g, align: w, trigger: A, morph: R, contentClassName: W, children: [
    /* @__PURE__ */ o("div", { className: `shrink-0 ${b.headerText}`, children: H }),
    /* @__PURE__ */ o("div", { ref: Q, className: "flex-1 min-h-0 overflow-y-auto scrollbar-custom flex flex-col", children: n.map((T) => {
      const F = T.id === r, M = y === T.id;
      return /* @__PURE__ */ o("div", { "data-active": F ? "1" : void 0, className: `flex items-center gap-1 rounded my-0.5 ${F || M ? b.rowActiveBg : b.rowHoverBg} ${y && !M ? "opacity-40 pointer-events-none" : ""}`, children: M ? /* @__PURE__ */ $(Ne, { children: [
        /* @__PURE__ */ o("div", { className: `flex-1 min-w-0 ${b.itemPad} rounded outline-none flex items-center gap-2`, children: /* @__PURE__ */ o(
          "input",
          {
            ref: Y,
            value: S,
        ...
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            children: /* @__PURE__ */ o(Wt, { className: b.btnIcon })
          }
        ),
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            children: /* @__PURE__ */ o(at, { className: b.btnIcon })
          }
        )
        ...
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            children: /* @__PURE__ */ o("span", { className: `truncate ${F ? b.rowActiveText : ""}`, children: L ? L(T) : T.name })
          }
        ),
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            disabled: p,
            children: /* @__PURE__ */ o(mn, { className: b.btnIcon })
          }
        ),
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            disabled: p,
            children: /* @__PURE__ */ o(Yt, { className: b.btnIcon })
          }
        ),
        /* @__PURE__ */ o(
          j.Item,
          {
            ...
            children: /* @__PURE__ */ o(ut, { className: b.btnIcon })
          }
        )
      ] }) }, T.id);
    }) }),
    /* @__PURE__ */ $("div", { className: `shrink-0 ${y ? "opacity-40 pointer-events-none" : ""}`, children: [
      h && /* @__PURE__ */ $(Ne, { children: [
        /* @__PURE__ */ o(j.Separator, { className: b.separator }),
        /* @__PURE__ */ $(
          j.Item,
          {
            ...
            disabled: p,
            children: [
              /* @__PURE__ */ o(qt, { className: `${b.btnIcon} ${b.icon}` }),
              "Reset to Default"
            ]
          }
        )
      ] }),
      (c || f || s || d) && /* @__PURE__ */ o(j.Separator, { className: b.separator }),
      c && /* @__PURE__ */ $(
        j.Item,
        {
          className: `w-full text-left ${b.itemPad} rounded flex items-center gap-2 transition-colors outline-none cursor-pointer select-none ${b.itemDefault} ui-row`,
          ...
          disabled: p,
          children: [
            /* @__PURE__ */ o(pn, { className: `${b.btnIcon} ${b.icon}` }),
            "New ",
            te
          ]
        }
      ...
      d && /* @__PURE__ */ $(
        j.Item,
        {
          ...
          disabled: p,
          children: [
            /* @__PURE__ */ o(ut, { className: `${b.btnIcon} ${b.icon}` }),
            "Trash"
          ]
        }
      )
  ...
  return /* @__PURE__ */ $(
    j.Item,
    {
      ...
      children: [
        ...
        f && /* @__PURE__ */ o("span", { className: "shrink-0 ml-1 flex items-center", children: f }),
        c && /* @__PURE__ */ o(
          "span",
          {
...
function Jn({ id: e, label: t, icon: n, width: r, side: a = "right", children: i, contentClassName: l }) {
  ...
  return /* @__PURE__ */ $(j.Sub, { open: d || H, onOpenChange: (M) => c((k) => {
    ...
    /* @__PURE__ */ $(
      j.SubTrigger,
      {
        ...
        children: [
          a === "left" && /* @__PURE__ */ o(dt, { className: "w-3 h-3 ui-icon rotate-180 order-first" }),
          /* @__PURE__ */ $("span", { className: "flex items-center gap-2", children: [
            n && /* @__PURE__ */ o("span", { className: "ui-icon shrink-0", children: n }),
            t
          ] }),
          a === "right" && /* @__PURE__ */ o(dt, { className: "w-3 h-3 ui-icon" })
        ]
      }
    ),
    /* @__PURE__ */ o(j.Portal, { container: g ?? void 0, children: /* @__PURE__ */ o(
      j.SubContent,
      {
        ref: te,
        "data-theme": p,
        ...
        collisionPadding: 8,
        onPointerLeave: L.pointerLeave,
        children: /* @__PURE__ */ o(Ke.Provider, { value: L, children: i })
      }
    ) })
  ] });
}
const Ae = 8, Qn = N ? "px-4 py-3 text-sm" : "px-3 py-2 text-xs", er = N ? "text-sm" : "text-xs", Eo = ({ open: e, x: t, y: n, onClose: r, children: a, containerRef: i, morph: l = !0 }) => {
  ...
  return pe(() => {
    ...
    const y = u.current, C = y.offsetWidth, S = y.offsetHeight, O = (T = i == null ? void 0 : i.current) == null ? void 0 : T.getBoundingClientRect(), Y = O ? O.right : (c == null ? void 0 : c.innerWidth) ?? 0, Q = O ? O.bottom : (c == null ? void 0 : c.innerHeight) ?? 0, ee = O ? O.left : 0, E = O ? O.top : 0;
  ...
  }, [e, f, t, n, i]), e ? /* @__PURE__ */ $(j.Root, { open: e, onOpenChange: (y) => {
    y || r();
  }, modal: !1, children: [
    /* @__PURE__ */ o(j.Trigger, { asChild: !0, children: /* @__PURE__ */ o("span", { style: { position: "fixed", inset: 0 }, "aria-hidden": "true" }) }),
    /* @__PURE__ */ o(j.Portal, { children: /* @__PURE__ */ o($t.Provider, { value: "light", children: /* @__PURE__ */ o(zt.Provider, { value: { chain: h, setChain: d, morph: l, keyboardOpened: v, setKeyboardOpened: p }, children: /* @__PURE__ */ o(Ke.Provider, { value: g, children: /* @__PURE__ */ o(
      j.Content,
      {
        ref: R,
        "data-theme": "light",
...
}, zo = ({ onClick: e, variant: t = "default", icon: n, disabled: r = !1, selected: a = !1, trailing: i, children: l }) => {
  const u = Ct(), c = x(u);
  c.current = u;
  const f = x(null);
  K(() => {
...
}, Co = () => /* @__PURE__ */ o(j.Separator, { className: "ui-sep my-1" }), To = (e) => /* @__PURE__ */ o(Jn, { ...e, width: e.width || "min-w-[180px]!", contentClassName: "z-[10000]" }), ne = 16, rn = "[data-modal-stack]", ye = 220, Oe = "cubic-bezier(0.32, 0.72, 0, 1)", Ve = 0.94;
function Me() {
...
function It(e, t, n, r) {
  const a = ++e.current, i = t.getBoundingClientRect();
  t.style.transition = "none", t.style.transform = on(i, n), t.style.transformOrigin = "0 0", t.getBoundingClientRect(), requestAnimationFrame(() => {
    requestAnimationFrame(() => {
...
function Ot(e, t, n) {
  const r = ++e.current, a = t.getBoundingClientRect(), i = 1 - Ve, l = { left: a.left + a.width * i / 2, top: a.top + a.height * i / 2, width: a.width * Ve, height: a.height * Ve };
...
const nr = N ? "px-6" : "px-5", rr = N ? "py-3" : "py-2.5", or = N ? "text-sm" : "text-xs", ir = N ? "w-4 h-4" : "w-3.5 h-3.5", sr = N ? "text-base" : "text-sm", cr = N ? "w-5 h-5" : "w-4 h-4", st = N ? "px-6" : "px-5", lr = N ? "pt-6" : "pt-5", ar = N ? "pb-6" : "pb-5", ur = N ? "text-xs" : "text-[10px]", dr = N ? "w-3.5 h-3.5" : "w-3 h-3", fr = N ? "px-2.5 py-1.5" : "px-2 py-1", hr = N ? "px-6" : "px-5", mr = N ? "py-3" : "py-2";
function pr({
  open: e,
  onClose: t,
  title: n,
  ...
  K(() => {
    ...
    X(), P ? It(E, m, P.getBoundingClientRect(), ce) : tr(E, m, ce);
  }, [e, g]);
  const ge = V(() => {
    ...
    _.current = !0, T(!0), M.current = !0, X(), Ot(E, m, () => {
    ...
    P.removeAttribute("data-modal-stack"), P.removeAttribute("data-state"), P.removeAttribute("role"), P.removeAttribute("data-aria-hidden"), P.removeAttribute("tabindex"), P.setAttribute("aria-hidden", "true"), P.style.pointerEvents = "none", D.body.appendChild(P), Ot({ current: 0 }, P, () => {
  ...
  pe(() => {
    ...
    const oe = () => {
      ...
      const me = it(m);
      if (me.length > 0)
        m.style.opacity = "", m.style.pointerEvents = "", J = me[me.length - 1].getBoundingClientRect(), G = !0, P = requestAnimationFrame(oe);
      else if (G) {
        G = !1, J && !Me() && (X(), It(E, m, J, ce)), J = null;
      ...
      !P && it(m).length > 0 && (P = requestAnimationFrame(oe));
    });
    ...
    const J = new ResizeObserver(() => {
      ...
      if (R.current || _.current || it(m).length > 0) {
        D = G;
        return;
      }
      if (k.current) return;
      const oe = D;
      D = G, X();
      const se = m.getBoundingClientRect(), me = Pe(A.current ?? null), ae = !W.current && !b.current, tt = ae ? me.top + (me.height - oe) / 2 : se.top, De = ae ? me.top + (me.height - G) / 2 : se.top;
      m.style.transition = "none", m.style.height = `${oe}px`, ae && (m.style.top = `${tt}px`), v.current && (v.current.style.overflow = "hidden"), m.getBoundingClientRect(), requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          m.style.height === `${oe}px` && (m.style.transition = `height ${ye}ms ${Oe}${ae ? `, top ${ye}ms ${Oe}` : ""}`, m.style.height = `${G}px`, ae && (m.style.top = `${De}px`), window.setTimeout(() => {
  ...
  const de = V(() => {
    ...
    const P = A.current ?? null, J = (P == null ? void 0 : P.innerWidth) ?? 0, G = Pe(P), oe = de(), se = oe ? oe.width : Math.min(J - ne * 2, 576), me = oe ? oe.height : Math.min(G.height - ne * 2, 400);
    return {
  ...
  K(() => {
    ...
    const G = () => {
      ...
      const oe = (m == null ? void 0 : m.innerHeight) ?? 0, se = (m == null ? void 0 : m.innerWidth) ?? 0, ae = Pe(m).height < oe - P, tt = oe < C.current.h - P && se === C.current.w;
      ae || tt ? (b.current = !0, y.current && (clearTimeout(y.current), y.current = 0)) : y.current || (y.current = (m == null ? void 0 : m.setTimeout(() => {
        ...
        const De = d.current;
        if (!De) return;
        const $e = Pe(A.current ?? null), xe = De.getBoundingClientRect(), Lt = ((At = A.current) == null ? void 0 : At.innerWidth) ?? 0, nt = (m == null ? void 0 : m.innerHeight) ?? 0, fn = $e.height < nt - P || nt < C.current.h - P && (m == null ? void 0 : m.innerWidth) === C.current.w;
        C.current = { w: (m == null ? void 0 : m.innerWidth) ?? 0, h: nt };
        const We = xe.top >= $e.top + ne && xe.bottom <= $e.bottom - ne, Dt = () => {
          L({
            left: Math.max(ne, Math.min((Lt - xe.width) / 2, Lt - xe.width - ne)),
  ...
  const I = V((m) => {
    ...
    R.current = null;
  }, []), ie = R.current !== null, he = q !== null, be = he ? "" : "left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2", ze = `${a ? `${a} w-full` : "max-w-xl w-full"}`, we = {
    ...
    const G = Array.from(P.querySelectorAll("button[data-modal-confirm]")), oe = G.length > 0 ? G : Array.from(P.querySelectorAll("button")), se = oe[oe.length - 1];
    !se || se.disabled || (m.preventDefault(), se.click());
  }, []);
  return /* @__PURE__ */ o(ke.Root, { open: e, onOpenChange: (m) => {
    m || ge();
      ...
      ke.Content,
      {
        ...
        children: [
          f ? /* @__PURE__ */ $(
            "div",
            {
              className: `flex items-center justify-between ${st} ${lr} pb-4 ${ie ? "cursor-grabbing" : "cursor-grab"}`,
              onPointerDown: (m) => {
                O || I(m);
              },
              onPointerMove: Z,
              onPointerUp: re,
              children: [
                /* @__PURE__ */ o(ke.Title, { className: `${sr} font-bold text-white truncate`, children: n }),
                s && /* @__PURE__ */ o(ke.Close, { "data-modal-close": !0, className: "text-zinc-500 hover:text-white transition-colors shrink-0", children: /* @__PURE__ */ o(at, { className: cr }) })
              ]
            }
          ) : /* @__PURE__ */ $(
            "div",
            {
              className: `flex items-center justify-between ${nr} ${rr} border-b border-zinc-800 shrink-0 bg-zinc-950 ${ie ? "cursor-grabbing" : "cursor-grab"}`,
              onPointerDown: (m) => {
                O || I(m);
              },
              onPointerMove: Z,
              ...
              children: [
                /* @__PURE__ */ $("div", { className: "flex items-center gap-2 min-w-0", children: [
                  ...
                  /* @__PURE__ */ o(ke.Title, { className: `${or} font-bold text-white truncate`, children: n })
                ] }),
                /* @__PURE__ */ $("div", { className: "flex items-center gap-2", children: [
                  u && /* @__PURE__ */ $("button", { onClick: u, className: `flex items-center gap-1 ${ur} text-zinc-500 hover:text-zinc-300 transition-colors bg-zinc-800 hover:bg-zinc-700 rounded ${fr} shrink-0`, children: [
                    /* @__PURE__ */ o(qt, { className: dr }),
                    "Reset"
                  ] }),
                  s && /* @__PURE__ */ o(ke.Close, { "data-modal-close": !0, className: "text-zinc-500 hover:text-white transition-colors shrink-0", children: /* @__PURE__ */ o(at, { className: ir }) })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ o("div", { ref: v, className: `overflow-y-auto flex-1 bg-zinc-900 text-zinc-100${f ? ` ${st} pb-4` : ""}`, children: l }),
          i && /* @__PURE__ */ o("div", { ref: p, className: f ? `${st} ${ar}` : "shrink-0", children: f ? /* @__PURE__ */ o("div", { className: "flex items-center justify-end gap-2", children: i }) : i })
        ]
      }
    )
  ] }) });
...
function Ro({ children: e }) {
  return /* @__PURE__ */ o("div", { className: `flex items-center justify-end gap-3 ${hr} ${mr} border-t border-zinc-800 bg-zinc-950`, children: e });
}
...
function xr({ checked: e, onChange: t, disabled: n = !1, label: r, id: a, className: i = "", labelClassName: l = "", theme: u, variant: c = "pill", tone: f = "accent", block: s = !1 }) {
  const h = c !== "plain", d = N ? "w-5 h-5" : "w-4 h-4", v = N ? "w-5 h-5 rounded-md" : "w-4 h-4 rounded", p = N ? "w-3.5 h-3.5" : "w-3 h-3", g = N ? "text-sm" : "text-xs";
  return /* @__PURE__ */ $(
    "label",
    {
      className: `ui-checkbox ${h ? `ui-checkbox-pill ${N ? "px-4 py-3" : "px-3 py-2.5"} rounded-lg` : ""} ${f === "danger" ? "ui-checkbox-tone-danger" : ""} ${n ? "ui-disabled" : ""} ${i}`,
      ...
      children: [
        ...
        h ? /* @__PURE__ */ o("span", { className: "ui-check-indicator", "aria-hidden": !0, children: e ? /* @__PURE__ */ $("svg", { viewBox: "0 0 16 16", className: d, "aria-hidden": !0, children: [
        ...
        ] }) : /* @__PURE__ */ o("svg", { viewBox: "0 0 16 16", className: d, "aria-hidden": !0, children: /* @__PURE__ */ o("rect", { x: "1", y: "1", width: "14", height: "14", rx: "3.5", fill: "none", stroke: "currentColor", strokeWidth: 1.5 }) }) }) : /* @__PURE__ */ o("span", { className: `ui-checkbox-box ${v}`, "aria-hidden": !0, children: e && /* @__PURE__ */ o("svg", { viewBox: "0 0 12 12", fill: "none", className: p, "aria-hidden": !0, children: /* @__PURE__ */ o("path", { d: "M2 6.5 L5 9.5 L10 3", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
        r != null && /* @__PURE__ */ o("span", { className: `ui-checkbox-label ${g} ${l}`, children: r })
      ]
    }
  );
}
...
function Lo({ children: e }) {
  const [t, n] = B(null), [r, a] = B(!1), i = x(null), l = x(t);
  l.current = t;
  const u = V(() => {
    const p = l.current;
  ...
  const h = V(() => {
    ...
    if (t) {
      ...
      } else t.kind === "prompt" ? t.resolve(((g = (p = i.current) == null ? void 0 : p.value) == null ? void 0 : g.trim()) || null) : t.resolve();
      n(null);
    }
  }, [t, r]), d = t !== null;
  K(() => {
    ...
    d && /* @__PURE__ */ o(
      pr,
      {
        ...
        footer: t && /* @__PURE__ */ $(Ne, { children: [
          t.kind !== "alert" && /* @__PURE__ */ o(Ye, { variant: "ghost", onClick: v, children: "Cancel" }),
          t.kind === "alert" ? /* @__PURE__ */ o(Ye, { onClick: h, children: "OK" }) : t.kind === "confirm" ? /* @__PURE__ */ o(
            Ye,
            {
          ...
          ) : /* @__PURE__ */ o(Ye, { "data-modal-confirm": !0, onClick: h, children: "Save" })
        ] }),
        children: /* @__PURE__ */ $("div", { className: yr, children: [
          (t == null ? void 0 : t.options.message) && /* @__PURE__ */ o("p", { className: `${vr} text-zinc-400 leading-relaxed`, children: t.options.message }),
...
function Ao({
  ...
  return g.current = i, K(() => {
    ...
    e,
    t && l && /* @__PURE__ */ o(zr, { x: l.x, y: l.y, ms: n - v })
  ] });
}
function Mo() {
  const e = Kn();
...
function Po({
  ...
  const l = i["data-state"] === "open", u = Rr[t][e];
  let c = `${u.base} ${l ? u.open : ""}`;
  return e === "primary" && t === "light" && n && (c = l ? `${Ht} ${Sr}` : Ht), /* @__PURE__ */ o("button", { type: a, className: `${Tr} ${c} ${r}`, ...i });
}
...
function Io({ selected: e, onChange: t, theme: n = "light", showChips: r = !0, className: a = "", initialView: i }) {
  ...
  return /* @__PURE__ */ $("div", { className: `border rounded-lg overflow-hidden w-full ${R ? "border-zinc-700 bg-zinc-900" : "border-zinc-200 bg-white"} ${a}`, children: [
    /* @__PURE__ */ $("div", { className: `flex items-center justify-between px-3 py-2 border-b ${R ? "bg-zinc-800/60 border-zinc-700" : "bg-zinc-50 border-zinc-200"}`, children: [
      /* @__PURE__ */ o(
        "button",
        {
          ...
          children: /* @__PURE__ */ o(gn, { className: b })
        }
      ),
      d === "days" ? /* @__PURE__ */ o(
        "button",
      ...
      /* @__PURE__ */ o(
        "button",
        {
          ...
          children: /* @__PURE__ */ o(dt, { className: b })
        }
      )
    ] }),
    d === "months" ? /* @__PURE__ */ $("div", { children: [
      /* @__PURE__ */ o("div", { className: "grid grid-cols-3 text-center", children: Dr.map((E, _) => /* @__PURE__ */ $(
        "button",
        {
          type: "button",
          onClick: () => {
          ...
          children: [
            E,
            L(_) && /* @__PURE__ */ o("span", { className: `absolute bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 rounded-full ${_ === s ? "bg-white" : R ? "bg-blue-500" : "bg-zinc-900"}` })
          ]
        },
        E
      )) }),
      /* @__PURE__ */ o("div", { className: `text-center border-t ${R ? "border-zinc-800" : "border-zinc-100"}`, children: /* @__PURE__ */ o(
        "button",
        {
          type: "button",
          onClick: () => {
      ...
      Lr.map((E) => /* @__PURE__ */ o("div", { className: `${y} font-semibold uppercase tracking-wider border-b ${R ? "text-zinc-500 border-zinc-800" : "text-zinc-400 border-zinc-100"}`, children: E }, E)),
      H.map((E) => E.empty ? /* @__PURE__ */ o("div", {}, E.key) : /* @__PURE__ */ o(
        "button",
        {
          type: "button",
          onClick: () => z(E.key),
    ...
    r && e.length > 0 && /* @__PURE__ */ $("div", { className: `px-3 py-2 border-t ${R ? "border-zinc-700 bg-zinc-800/40" : "border-zinc-200 bg-zinc-50"}`, children: [
      ...
      /* @__PURE__ */ o("div", { className: "flex flex-wrap gap-1", children: e.map((E) => {
        ...
        return /* @__PURE__ */ $(
          "button",
          {
            ...
            children: [
              te,
              /* @__PURE__ */ o("span", { className: `leading-none ${R ? "text-zinc-400" : "text-zinc-500"}`, "aria-hidden": "true", children: "×" })
            ]
          },
          E
        );
...
function Oo({
  ...
  return /* @__PURE__ */ $("div", { className: h, ...s ? { "data-theme": s } : {}, children: [
    g && /* @__PURE__ */ $("div", { className: "flex items-center justify-between ui-checklist-header", children: [
      ...
      a != null && /* @__PURE__ */ o("button", { type: "button", disabled: f, onClick: a, className: "ui-checklist-toggleall", children: l ?? (i ? "Deselect all" : "Select all") })
    ] }),
    /* @__PURE__ */ $(
      "div",
      {
          ...
          e.map((w) => {
            ...
            return /* @__PURE__ */ $(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ o("span", { className: `ui-checklist-box ${p}`, "aria-hidden": !0, children: z && /* @__PURE__ */ o("svg", { className: "w-3 h-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", "aria-hidden": !0, children: /* @__PURE__ */ o("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 3, d: "M5 13l4 4L19 7" }) }) }),
          ...
          e.map((d) => {
            ...
            return /* @__PURE__ */ $(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ o("span", { className: `ui-radio-circle ${h}`, "aria-hidden": !0, children: v && /* @__PURE__ */ o("span", { className: "ui-radio-dot" }) }),
                  d.leading != null && /* @__PURE__ */ o("span", { className: "ui-checklist-leading", children: d.leading }),
                  /* @__PURE__ */ o("span", { className: "ui-checklist-label", children: d.label }),
                  d.secondary != null && /* @__PURE__ */ o("span", { className: "ui-checklist-secondary", children: d.secondary })
                ]
              },
              d.id
            );
          }),
          e.length === 0 && /* @__PURE__ */ o("div", { className: "ui-checklist-empty", children: a })
        ]
      }
    )
  ] });
...
const Ho = ({
  ...
  const n = Be(), r = Le(), [a, i] = B(!1), [l, u] = B({ x: 0, y: 0 }), c = x(null), f = () => {
    if (!c.current) return;
        ...
        a && xt(
          /* @__PURE__ */ $(
            "div",
            {
              ...
              children: [
                e.split(`
• `).map((s, h) => /* @__PURE__ */ o("div", { className: h > 0 ? "mt-0.5 pt-0.5 border-t border-zinc-700" : "", children: s }, h)),
...
function Wr(e) {
  ...
  for (const n of e.split(";")) {
    const r = n.indexOf(":");
    if (r < 0) continue;
    const a = n.slice(0, r).trim().toLowerCase(), i = n.slice(r + 1).trim();
    Fr.has(a) && i && t.push(`${a}: ${i}`);
  }
  return t.join("; ");
}
function bt(e) {
  ...
  const a = document.createElement(n), i = t.getAttribute("style"), l = Wr(i || "");
...
const qr = { text: "#52525b" }, Ur = ({ node: e, selected: t, extension: n, editor: r, view: a, getPos: i }) => {
  var h;
  ...
  return /* @__PURE__ */ o(
    Rn,
    {
      ...
      onMouseDown: (d) => {
        ...
        const v = typeof i == "function" ? i() : null;
        if (v == null) return;
...
const Vr = _n.extend({
  ...
  const i = Et();
  return /* @__PURE__ */ o(Ke.Provider, { value: n, children: /* @__PURE__ */ o(
    "div",
    {
      className: "ui-menu rounded-lg shadow-xl p-1 flex flex-col min-w-[220px] overflow-y-auto",
      style: { width: Gr, maxHeight: Xr },
      onMouseDown: (l) => l.preventDefault(),
      children: /* @__PURE__ */ o("div", { ref: a, children: e.items.map((l) => /* @__PURE__ */ o(
        Jr,
        {
          item: l,
          d: i,
  ...
  const { myIndex: r, highlighted: a, setPointer: i } = nn({
    label: () => e.label,
    activate: n
  });
  return /* @__PURE__ */ $(
  ...
  return {
    ...
    onKeyDown({ event: n }) {
      ...
      const i = e.api, l = n.key;
      if (l === "ArrowDown" || l === "ArrowUp") {
        n.preventDefault();
        const u = i.highlightedIndex, c = l === "ArrowDown" ? 1 : -1;
        return i.setHighlighted((u + c + r.length) % r.length, "keyboard"), !0;
      }
      if (l === "Enter" || l === "Tab") {
        n.preventDefault();
        const u = i.highlightedIndex, c = u >= 0 ? u : 0, f = i.items[c];
...
}, Xo = { bold: !1, italic: !1, underline: !1, strike: !1, link: !1, color: "" }, eo = Ee.forwardRef(({
  value: e,
  onChange: t,
  placeholder: n,
  disabled: r,
  ...
  }), [b]), /* @__PURE__ */ o(Ln, { editor: b, className: `richtext-editor ${a || ""}` });
});
eo.displayName = "RichTextEditor";
const to = ["Helvetica", "Arial", "Times New Roman", "Georgia", "Courier New"], no = ["#b91c1c", "#b45309", "#15803d", "#1d4ed8", "#7c3aed", "#6b7280"], Ft = ({ className: e = "w-3 h-3" }) => /* @__PURE__ */ o("span", { className: `${e} rounded-full border border-zinc-600 relative inline-flex items-center justify-center shrink-0`, children: /* @__PURE__ */ o("span", { className: "absolute left-0 right-0 top-1/2 h-px bg-zinc-400 -rotate-45" }) }), Go = ({ value: e, disabled: t, onChange: n }) => {
  const [r, a] = B(!1);
  return /* @__PURE__ */ o(
    et,
    {
      ...
      trigger: /* @__PURE__ */ $("button", { type: "button", disabled: t, className: `${un} disabled:pointer-events-none`, children: [
        ...
        /* @__PURE__ */ o(Ut, { className: "w-3 h-3 text-zinc-500 shrink-0" })
      ] }),
      children: to.map((i) => /* @__PURE__ */ o(Gn, { onClick: () => {
        n(i), a(!1);
      }, icon: i === e ? /* @__PURE__ */ o(Wt, { className: "w-3.5 h-3.5" }) : void 0, children: /* @__PURE__ */ o("span", { style: { fontFamily: i }, children: i }) }, i))
    }
  );
}, ro = ({ editorRef: e, disabled: t, active: n }) => {
  const [r, a] = B(!1), [i, l] = B(""), u = () => {
    var f;
    const c = i.trim();
  ...
  return /* @__PURE__ */ o(
    et,
    {
      ...
      children: /* @__PURE__ */ $("div", { className: "p-2 flex flex-col gap-2", children: [
        ...
        /* @__PURE__ */ $("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ o("button", { onClick: u, className: gt, disabled: !i.trim(), children: "Apply" }),
          /* @__PURE__ */ o(
            "button",
            {
              onClick: () => {
...
}, Zo = ({ editorRef: e, disabled: t, active: n, lockedFormatting: r, trailing: a }) => {
  const [i, l] = B(!1), u = (s, h) => {
    var d;
  ...
  return /* @__PURE__ */ $("div", { className: "flex items-center gap-1", children: [
    /* @__PURE__ */ o(Ie, { content: (r == null ? void 0 : r.bold) || "Bold", children: /* @__PURE__ */ o("button", { "aria-label": "Bold", disabled: t || f("bold"), onMouseDown: (s) => s.preventDefault(), onClick: () => u("bold"), className: `${c(((n == null ? void 0 : n.bold) ?? !1) || f("bold"))} font-bold`, children: "B" }) }),
    /* @__PURE__ */ o(Ie, { content: (r == null ? void 0 : r.italic) || "Italic", children: /* @__PURE__ */ o("button", { "aria-label": "Italic", disabled: t || f("italic"), onMouseDown: (s) => s.preventDefault(), onClick: () => u("italic"), className: `${c(((n == null ? void 0 : n.italic) ?? !1) || f("italic"))} italic`, children: "I" }) }),
    /* @__PURE__ */ o(Ie, { content: "Underline", children: /* @__PURE__ */ o("button", { "aria-label": "Underline", disabled: t, onMouseDown: (s) => s.preventDefault(), onClick: () => u("underline"), className: c((n == null ? void 0 : n.underline) ?? !1), children: /* @__PURE__ */ o(yn, { className: "w-3 h-3" }) }) }),
    /* @__PURE__ */ o(Ie, { content: "Strikethrough", children: /* @__PURE__ */ o("button", { "aria-label": "Strikethrough", disabled: t, onMouseDown: (s) => s.preventDefault(), onClick: () => u("strikeThrough"), className: c((n == null ? void 0 : n.strike) ?? !1), children: /* @__PURE__ */ o(vn, { className: "w-3 h-3" }) }) }),
    /* @__PURE__ */ o("div", { className: Xe }),
    /* @__PURE__ */ o(ro, { editorRef: e, disabled: t, active: (n == null ? void 0 : n.link) ?? !1 }),
    /* @__PURE__ */ o("div", { className: Xe }),
    /* @__PURE__ */ o(
      et,
      {
        ...
        trigger: /* @__PURE__ */ $("button", { type: "button", disabled: t, className: `${un} disabled:pointer-events-none`, title: "Text color", children: [
          n != null && n.color ? /* @__PURE__ */ o("span", { className: "w-3 h-3 rounded-full border border-zinc-600 shrink-0", style: { background: n.color } }) : /* @__PURE__ */ o(Ft, {}),
          /* @__PURE__ */ o(Ut, { className: "w-3 h-3 text-zinc-500" })
        ] }),
        children: /* @__PURE__ */ $("div", { className: "grid grid-cols-4 gap-1 p-2", children: [
          /* @__PURE__ */ o(
            "button",
            {
              ...
              children: /* @__PURE__ */ o(Ft, { className: "w-3.5 h-3.5" })
            }
          ),
          no.map((s) => /* @__PURE__ */ o(
            "button",
...
export {
  ...
  Yo as ContentRow,
  Eo as ContextMenu,
  Co as ContextMenuDivider,
  zo as ContextMenuItem,
  To as ContextMenuSub,
  Io as DatePicker,
  Lo as DialogProvider,
  Gn as DropdownItem,
  et as DropdownMenu,
